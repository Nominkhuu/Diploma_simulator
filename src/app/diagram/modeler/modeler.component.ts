      ...
      if (!isNaN(this.diagramId) && params.get('id') != null) {
        this.diagramService.getDiagram(this.diagramId)
          ...
          .subscribe(
            ...
            error => {
              this.snackBarRef = this.snackBar.open('Уншиж болохгүй байна', 'Дахин оролдон уу', {
                duration: 4000,
      ...
      this.diagramService.updateDiagram(this.diagramId, this.diagramService.getLoadedDiagramName(), this.diagramXml, image)
        .subscribe(
          res => {
            this.isLoading = false;
            console.log(res);
            this.snackBar.open('Амжилттай хадгалагдалаа.', null, {
              duration: 2000,
              verticalPosition: 'top',
              horizontalPosition: 'end',
          ...
          error => {
            console.log(error);
            this.snackBar.open(`Болсонгүй дахин оролдон уу.`, null, {
              duration: 2000,
              verticalPosition: 'top',
              horizontalPosition: 'end',
              panelClass: ['error-snackbar']
